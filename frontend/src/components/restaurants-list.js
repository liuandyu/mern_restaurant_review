...
const RestaurantsList = props => {
    ...
    //after render retrieve restaurant and cuisines
    useEffect( () => {
        retrieveRestaurants();
        retrieveCuisines();
    }, []);
                    ...
                    <div className="col-lg-4 pb-1">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <Link to={"/restaurants/" + restaurant._id} className="btn btn-primary col-log-5 mx-1 mb-1">
                                        View Reviews
                                    </Link>
                                    <a target="_blank" rel="noreferrer" href={"https://www.google.com/maps/place/" + address} className="btn btn-primary col-log-5 mx-1 mb-1">View Map</a>
                                </div>
                            </div>
                        </div>
                    </div>
